...
@InputType()
class ReservationCreateNestedManyWithoutEventsInput {
...
export { ReservationCreateNestedManyWithoutEventsInput as ReservationCreateNestedManyWithoutEventsInput };
